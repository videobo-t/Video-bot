...
def _fetch_one_image(args):
    ...
    r.raise_for_status()  # son denemede de basarisizsa hatayi yukari firlat
    return i, out_path


def generate_images(scenes: list, job_id: str) -> list:
    # Cok fazla ayni anda istek atmamak icin dusuk paralellik + otomatik
    # tekrar deneme (429 rate limit hatasina karsi) kullaniyoruz
