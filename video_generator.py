...
def _fetch_one_image(i, prompt, job_id):
    url = (
...
def generate_images(scenes: list, job_id: str) -> list:
    # Pollinations.ai anonim kullanimda ~15 saniyede 1 istege izin veriyor.
    # Bu yuzden gorselleri sirayla, aralarinda bekleyerek indiriyoruz.
    image_paths = []
    for i, scene in enumerate(scenes):
        path = _fetch_one_image(i, scene["image_prompt"], job_id)
